...
<style>
    ...
    @media print {
        ...
        #resumenCuadernoContenido .pagina-cuaderno { flex: 1 1 auto; width: 100%; min-height: 0 !important; background-size: auto 24px; background-image: repeating-linear-gradient(transparent, transparent 23px, #cbd5e1 24px) !important; display: flex; flex-direction: column; }
        #resumenCuadernoContenido .lapicero { flex: 1 1 auto; min-height: 0; display: flex; flex-direction: column; font-size: 16px; line-height: 24px; }
