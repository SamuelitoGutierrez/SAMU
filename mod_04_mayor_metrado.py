...
SUB_PARTIDAS_HTML = """
<style>
    /* Estilos del buscador predictivo heredados */
...
<div class="step-view" id="step5">
    ...
    <p class="text-muted small mb-3">Busque la sub partida y presione <b>Enter</b>. Digite el metrado y presione <b>Enter</b> nuevamente. <span class="text-primary fw-bold">(El metrado es opcional).</span></p>
    
    <div class="position-relative mb-4">
        <div class="input-group shadow-sm">
            <span class="input-group-text bg-white border-end-0"><i class="bi bi-search text-primary"></i></span>
            <input type="text" class="form-control border-start-0 ps-0" id="m5_buscador" placeholder="Ej: 07.01 o Transporte..." autocomplete="off" onkeyup="m5_teclas(event)" onfocus="m5_filtrar()" oninput="m5_filtrar()">
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content" style="border-radius: 20px; border: 2px solid #0263a0; box-shadow: 0 20px 40px rgba(2,99,160,0.15);">
            <div class="modal-body p-4 text-center">
                ...
                <h6 class="fw-bold text-dark mb-3" id="m5_lbl_desc" style="line-height: 1.3;">Descripción de la Partida</h6>
