...
# Módulo: Llenado de Cuaderno de Obra - Versión Completa y Alineada
# =========================================================
...
def redaccion_asiento_residente():
    ...
    <head>
        ...
        <style>
            ...
            body { font-family: 'Inter', sans-serif; background-color: #fbfbfd; color: var(--apple-text); overflow-x: hidden; padding-bottom: 90px; margin: 0;}
            ...
            .step-view { display: none; animation: fadeIn 0.4s ease; background: rgba(255,255,255,0.8); backdrop-filter: blur(20px); padding: 30px; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.02); border: 1px solid rgba(255,255,255,0.9);}
            ...
            /* ==========================================
               CUADERNO FÍSICO (ALINEACIÓN PERFECTA)
               ========================================== */
            .papel-fisico {
            ...
            /* Datos Estáticos Superiores */
            .p-meta { margin-bottom: 15px; }
            ...
            /* Líneas del Cuaderno y Texto Dinámico */
            .p-body-lines {
            ...
            /* TINTA CELESTE PRINCIPAL: Calibrada para sentarse sobre la línea */
            .lapicero { 
                font-family: 'Caveat', cursive; color: var(--celeste-obra); 
                font-size: 20px; line-height: 28px; /* Debe coincidir con el background */
                padding-left: 5px; font-weight: 700; 
            }
            
            .lapicero-muted { font-family: 'Caveat', cursive; color: #64748b; font-size: 20px; padding-left: 20px; font-weight: 600;}
            .p-van { position: absolute; bottom: 0; right: 10px; font-family: 'Caveat', cursive; color: var(--celeste-obra); font-size: 20px; font-weight: 700;}
            ...
            /* ==========================================
               BARRA INFERIOR (CONTROLES Y SLIDER)
               ========================================== */
    ...
    <body>
        ...
        <div class="split-layout">
            ...
            <div class="form-column">
                ...
                <form id="formResidencia" oninput="sincronizarDatos()">
                    ...
                    <div class="step-view" id="step3"><div class="step-title">3.- PARTIDAS EJECUTADAS</div><textarea class="form-control req-step3" id="v_partidas" rows="6" placeholder="Registre las partidas y metrados..."></textarea></div>
                    <div class="step-view" id="step4"><div class="step-title">4.- PARTIDAS DE MAYOR METRADO</div><textarea class="form-control req-step4" id="v_mayor_m" rows="6" placeholder="Registre excesos de metrado..."></textarea></div>
                    ...
                    <div class="step-view" id="step7"><div class="step-title">7.- MOVIMIENTO DE ALMACÉN</div><textarea class="form-control req-step7" id="v_almacen" rows="6" placeholder="Ingresos y salidas de almacén..."></textarea></div>
                    <div class="step-view" id="step8"><div class="step-title">8.- MAQUINARIAS Y EQUIPOS</div><textarea class="form-control req-step8" id="v_maquina" rows="6" placeholder="Maquinarias del GORE y servicios..."></textarea></div>
                    ...
                    <div class="step-view" id="step10"><div class="step-title text-danger">10.- OCURRENCIAS Y OTROS</div><textarea class="form-control border-danger req-step10" id="v_ocurrencia" rows="8" placeholder="Ocurrencias, consultas legales..."></textarea></div>
                ...
                <div class="papel-fisico" id="papelOficial">
                    ...
                    <div class="p-header-top">
                        ...
                        <div style="text-align: right; width: 110px;">
                            <div class="p-num">Nº <span style="font-size: 30px; margin-left:5px;">{{ numero_asiento }}</span></div>
        ...
        <script>
            ...
            // 3. UI Dinámica: Relojes y Cascos
            ...
            // 4. Sincronización y Renderizado en el Cuaderno Físico
            function sincronizarDatos() {
                // Termómetros del Stepper
                for (let i = 1; i <= 10; i++) {
                ...
                // ==========================================
                // GENERADOR DE TINTA (Alineado a las líneas)
                // ==========================================
                let numAsiento = "{{ numero_asiento }}";
                let fechaLarga = "{{ fecha_hoy }}";
                
                // Usamos <br> y aseguramos que el texto fluya naturalmente respetando el line-height de 28px
                let textoPapel = `&nbsp;&nbsp;ASIENTO No ${numAsiento} DEL RESIDENTE DE OBRA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${fechaLarga}<br>`;
                ...
                // 2. Personal (Formato con ceros y espacios alineados)
                ...
                // Demás puntos (3 al 10)
                const camposText = [
                    {id: 'partidas', titulo: '3.- PARTIDAS EJECUTADAS'},
